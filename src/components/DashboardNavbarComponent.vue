...
<template>
    <nav ref="navElement" :style="{ minHeight: computedHeight }">
        ...
        <a :class="{ underline: props.plugin === Plugins.LEAVE_MESSAGE }"
            @click="selectPlugin(Plugins.LEAVE_MESSAGE)">Leave Message</a>
